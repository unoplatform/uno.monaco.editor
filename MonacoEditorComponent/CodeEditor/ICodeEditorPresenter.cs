...
namespace Monaco
{
    ...
    public interface ICodeEditorPresenter
	{
        ...
        /// <summary>Gets or sets the parent <see cref="EditorHostBase"/> that owns this presenter.</summary>
        public EditorHostBase? ParentCodeEditor { get; set; }

		/// <summary>Routes a key-down event from JavaScript to the parent editor's <see cref="EditorHostBase.KeyDown"/> handler.</summary>
