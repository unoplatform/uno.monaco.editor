...
- **Verify Monaco version**: Check `MonacoEditorComponent/monaco-editor/package.json` for the actual shipped version — do not hard-code without verification
...
- Note verified Monaco Editor version shipped. Include brief highlights of significant Monaco upstream changes if notable.
...
- [ ] Monaco Editor version verified from `MonacoEditorComponent/monaco-editor/package.json` and noted
