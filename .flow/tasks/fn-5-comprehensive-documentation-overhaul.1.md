...
- **Pin exact commit range**: Record base SHA (merge-base with main), head SHA, and commit count at time of writing. Include these in the document header so readers know what scope the guide covers.
